package com.oiis.sso_starter.server.auth.github;

import com.oiis.libs.java.spring.commons.DefaultDataSwap;
import com.oiis.sso_starter.server.auth.github.dtos.HandleCodeDTOG;
import com.oiis.sso_starter.services.auth.github.GitHubAuthService;
...
public class GitHubAuthController {
    ...
    public ResponseEntity<DefaultDataSwap> getLoginUrl() {
        ...
        return gitHubAuthService.getLoginUrl().sendHttpResponse();
    }
    ...
    public ResponseEntity<?> handleCode(@RequestBody HandleCodeDTOG handleCodeDto) {
